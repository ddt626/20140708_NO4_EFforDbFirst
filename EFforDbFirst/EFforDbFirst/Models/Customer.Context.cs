...
namespace EFforDbFirst.Models
{
    ...
    public partial class 客戶資料Entities : DbContext
    {
        ...
        public virtual ObjectResult<abdcdd> Get_Client(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<abdcdd>("Get_Client", idParameter);
        }
    }
}
